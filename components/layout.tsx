        ...
        <nav className="fixed bottom-0 w-full max-w-lg pt-2.5 pb-5 bg-white border-t px-4 flex items-center justify-between text-xs text-gray-800">
          ...
          <div
            className={cls(
              ...
              pathname === "/" ? "text-slate-900" : "text-gray-500"
            )}
            onClick={() => push(`/`)}
          >
            {pathname === "/" ? (
          ...
          <div
            className={cls(
              "flex flex-col gap-y-1 items-center cursor-pointer",
              pathname === "/community" ? "text-slate-900" : "text-gray-500"
            )}
          ...
          <div
            className={cls(
              "flex flex-col gap-y-1 items-center cursor-pointer",
              pathname === "/streams" ? "text-slate-900" : "text-gray-500"
            )}
          ...
          <div
            className={cls(
              "flex flex-col gap-y-1 items-center cursor-pointer",
              pathname === "/chats" ? "text-slate-900" : "text-gray-500"
            )}
            onClick={() => push(`/chats`)}
          >
            {pathname === "/chats" ? (
          ...
          <div
            className={cls(
              "flex flex-col gap-y-1 items-center cursor-pointer",
              pathname === "/profile" ? "text-slate-900" : "text-gray-500"
            )}
