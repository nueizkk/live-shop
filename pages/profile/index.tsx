    ...
    <Layout title="프로필" hasTabBar>
      <div className="p-4">
        <div className="flex items-center gap-x-3">
          <div className="w-16 rounded-full aspect-square bg-slate-300" />
        ...
        <div className="flex justify-around mt-10">
          ...
          >
            ...
            <span className="text-sm font-medium text-gray-700">관심내역</span>
          </div>
        </div>
        {/*  */}
        <div className="mt-12">
          <div className="flex items-center gap-x-4">
            ...
            <div className="flex flex-col items-start">
              <h4 className="text-sm font-bold text-gray-800">지은</h4>
