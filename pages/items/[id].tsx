    ...
    <Layout title="상세보기" canGoBack>
      <div className="p-4">
        <div className="mb-8">
          ...
          <div className="flex items-center py-3 border-t border-b gap-x-3">
          ...
          <div className="mt-5">
            ...
            <div className="mt-3 text-3xl text-gray-900">$140</div>
            ...
            <div className="flex items-center justify-between gap-x-2">
              ...
              <button className="flex items-center p-3 text-gray-400 transition-colors justify-contents hover:text-gray-500 group">
                <svg
                  className="w-6 h-6 group-hover:fill-orange-600 group-hover:stroke-orange-600"
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            {[1, 2, 3, 4, 5, 6].map((_, i) => (
              <div key={i}>
                <div className="w-full mb-4 aspect-square bg-slate-300" />
